...
class Fraction:
    ...
    def __init__(self):
        ...
        self.trans_dict = {
            "½": {"prepended": "a", "single": "one", "text": "half"},
            "⅓": {"prepended": "a", "single": "one", "text": "third"},
            "⅔": {"prepended": "two", "single": "two", "text": "thirds"},
            "¼": {"prepended": "a", "single": "one", "text": "quarter"},
            "¾": {"prepended": "three", "single": "three", "text": "quarters"},
            "⅕": {"prepended": "a", "single": "one", "text": "fifth"},
            "⅖": {"prepended": "two", "single": "two", "text": "fifths"},
            "⅗": {"prepended": "three", "single": "three", "text": "fifths"},
            "⅘": {"prepended": "four", "single": "four", "text": "fifths"},
            "⅙": {"prepended": "a", "single": "one", "text": "sixth"},
            "⅚": {"prepended": "five", "single": "five", "text": "sixths"},
            "⅐": {"prepended": "a", "single": "one", "text": "sixth"},
            "⅛": {"prepended": "an", "single": "one", "text": "eighth"},
            "⅜": {"prepended": "three", "single": "three", "text": "eighths"},
            "⅝": {"prepended": "five", "single": "five", "text": "eighths"},
            "⅞": {"prepended": "seven", "single": "seven", "text": "eighths"},
            "⅑": {"prepended": "a", "single": "one", "text": "ninth"},
            "⅒": {"prepended": "a", "single": "one", "text": "tenth"},
        }
        ...
        self.edge_dict = {
            "1": {"singular": "over one", "plural": "over one"},
        ...
        if match:
            ...
            if match:
                ...
                if denominator in self.edge_dict:
                    ...
                    denominator_text_list[-1] = self.trans_denominator[
